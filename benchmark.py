...
if __name__ == '__main__':
    ...
    # Note: scripts benchmarks only model training time, metrics and other post train step actions are not run
...
- GPU usage around 80%
2. LSUN Living Room (new: implemented and enabled XLA)
...
3. LSUN Living Room (new: implemented and enabled XLA, batch size x2 for target resolution)
...
- No metrics were ran
4. LSUN Living Room (new: implemented and enabled XLA, batch size x2 for target resolution), target resolution, 
transition stage
- Benchmark took 12m 14s for 10000 images. In average 13.621 images/sec.
- GPU usage around 87-90%
- No metrics were ran
5. LSUN Living Room (new: implemented and enabled XLA, batch size x2 - 16 for target resolution), target resolution, 
transition stage, all swish activations
- OOM
6. LSUN Living Room (new: implemented and enabled XLA, batch size x2 - 16 for target resolution), target resolution, 
transition stage, all selu activations
- OOM
7. LSUN Living Room (new: implemented and enabled XLA, batch size x2 - 16 for target resolution), target resolution, 
transition stage, selu activation for mapping
- Benchmark took 12m 07s for 10000 images. In average 13.750 images/sec.
8. LSUN Living Room (new: implemented and enabled XLA, batch size x2 - 16 for target resolution), target resolution, 
transition stage, selu activation for mapping, h-swish for G and D
-  OOM
9. LSUN Living Room (new: implemented and enabled XLA, batch size x1.5 - 12 for target resolution), target resolution, 
transition stage, selu activation for mapping, h-swish for G and D
-  OOM
10. LSUN Living Room (new: implemented and enabled XLA, batch size x1 - 8 for target resolution), target resolution, 
transition stage, selu activation for mapping, h-swish for G and D
